...
print("Training lr set score: {:.2f}".format(lr.score(Xtrain_prep, ytrain))) #0.85
...
print("Training ridge set score: {:.2f}".format(ridge.score(Xtrain_prep, ytrain))) #0.85
print("Test ridge set score: {:.2f}".format(ridge.score(Xtest_prep, ytest))) #0.81

ridge10 = Ridge(alpha=10).fit(Xtrain_prep, ytrain)
print("Training ridge set score: {:.2f}".format(ridge10.score(Xtrain_prep, ytrain))) #0.85
...
print ("linear regression train score:", train_score) #0.85
print ("linear regression test score:", test_score) #0.78
print ("ridge regression train score low alpha:", ridge_train_score)#0.85
print ("ridge regression test score low alpha:", ridge_test_score) #078
print ("ridge regression train score high alpha:", ridge_train_score100) # 0.85
print ("ridge regression test score high alpha:", ridge_test_score100) #0.82
print ("lasso regression train score:", train_lasso_score ) #0,84
print ("lasso regression test score:", test_lasso_score ) #0,83
print ("nombe de features:", coeff_used ) #14
print ("training score for alpha=0.01", train_score001  ) #0,84
print ("test score for alpha=0.01:", test_score001 ) #0,81
print ("nombe de features:", coeff_used ) #14
print ("training score for alpha=0.0001", train_score00001  ) #0,84
print ("test score for alpha=0.0001:", test_score00001 ) #0,81
print ("nombe de features:", coeff_used ) #14
