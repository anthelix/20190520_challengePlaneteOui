...
#-------------------------LOG---------------------------------------------
# 1er log                               |n_estimators a 200 => no change
#linear Regression :  RMSE 27.05        |max_depth = 30 => idem                     LAISSER A 30
#   Metric de l'ENS 21.84               |   Multi Output RFR :  RMSE 16.06
#Ridge01 :  RMSE 27.05                  |   Metric de l'ENS 11.43 
#    Metric de l'ENS 21.84              |mettre 'Year" en categories                LAISSER YEAR EN CATEGORIES
#Ridge100 :  RMSE 23.86                 |   Multi Output RFR :  RMSE 16.08
#   Metric de l'ENS 18.84               |   Metric de l'ENS 11.45 == submit1
#Lasso :  RMSE 21.41                    |les 'consumption' separe et non plus en moyenne LAISSER EN MOYENNE 
#   Metric de l'ENS 16.06               |   Multi Output RFR :  RMSE 16.69
#Lasso1 alpha.01 :  RMSE 22.56          |   Metric de l'ENS 12.09
#   Metric de l'ENS 17.66               |n_estimators=20 ==>                        LAISSER A 20
#Lasso alpha00001 :  RMSE 23.20         |   Multi Output RFR :  RMSE 16.03
#   Metric de l'ENS 18.25               |   Metric de l'ENS 11.40
#Elastic Net ratio 0,5 :  RMSE 25.41    |
#   Metric de l'ENS 20.09               |
#Elasic Net ratio 1:  RMSE 21.41        |
#   Metric de l'ENS 16.06               |
#Multi Output GBR :  RMSE 16.98         |
#   Metric de l'ENS 12.47               |
#Multi Output RFR :  RMSE 16.10         |
#   Metric de l'ENS 11.46               |
